...
def populateSet(song_uris, database, genre, decade):
	...
	pickle.dump(song_uris, open("song_uris_" + decade + ".p", "wb"))
...
genres = pickle.load(open("genres-dict.p", "rb"))
...
try:
	...
	for decade in decades:
		...
		try:
			song_uris = pickle.load(open("song_uris_" + decade + ".p", "rb"))
		
		except:
			song_uris = set()

		try:
			database = pickle.load(open("genre_track_" + decade + "_db.p", "rb"))
		...
		for i in range(start, 1000):
			...
			for genre in genres[decade]:
				...
				pickle.dump(database, open("genre_" + decade + "_database.p", "wb"))
